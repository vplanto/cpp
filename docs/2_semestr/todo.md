...
* **[TODO]:** Оскільки концепцію ітераторів наразі пропущено/не винесено в окрему тему до Блоку 3, студенти зустрічають `begin()/end()` в Лекції 27 без попередньої теоретичної бази. Необхідно або додати вступну частину про ітератори до Лекції 20 (Lists & Vector), або виділити під них окремий підрозділ.

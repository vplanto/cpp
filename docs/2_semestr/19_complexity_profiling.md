...
### Порівняння складності: Масштаби Всесвіту
...
| Алгоритм | n=1,000 | n=1,000,000 | n=1,000,000,000 |
|-----------|---------|-------------|-----------------|
| **O(1)** | 1 ns | 1 ns  | 1 ns |
| **O(log n)** | ~10 ns | ~20 ns | ~30 ns |
| **O(n)** | 1 μs | 1 ms | 1 секунда |
| **O(n log n)** | 10 μs | 20 ms | 30 секунд |
| **O(n²)** | 1 ms | 16.7 хвилин | **31,688 років** |
| **O(2ⁿ)** | **10²⁸¹ тисячоліть** | Теплова смерть Всесвіту | Незбагненно |

**Ключові висновки:**
- O(n²) для n=10⁹: **31 тисяча років**. Це довше, ніж існує письменність людства!
- O(2ⁿ) для n=1000: **10²⁸¹ тисячоліть** (одиниця з 281 нулем). Для порівняння, вік Всесвіту — 10¹⁰ років.
